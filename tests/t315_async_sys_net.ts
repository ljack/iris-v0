...
export const t321_async_sys_self: TestCase = {
  ...
  expect: 'RuntimeError: Unknown intrinsic or not implemented in Sync path: sys.self ',
  source: `(program
...
export const t322_async_sys_spawn: TestCase = {
  ...
  expect: 'RuntimeError: Unknown intrinsic or not implemented in Sync path: sys.spawn ',
  source: `(program
...
export const t326_async_http_parse_request: TestCase = {
  ...
  expect: '(Ok (record (body "") (headers (list )) (method "GET") (path "/")))',
  source: `(program
...
export const t327_async_http_parse_response: TestCase = {
  ...
  expect: '(Ok (record (body "") (headers (list )) (status 200) (version "HTTP/1.1")))',
  source: `(program
