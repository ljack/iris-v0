...
export const t339_async_unknown_intrinsic: TestCase = {
  ...
  expect: 'TypeError: Unknown function call: unknown.op',
  source: `(program
...
export const t340_async_i64_from_string_empty: TestCase = {
  ...
  expect: 'RuntimeError: Unknown intrinsic or not implemented in Sync path: i64.from_string ',
  source: `(program
...
export const t344_async_bool_and_error: TestCase = {
  ...
  expect: 'TypeError: Expected Bool for &&',
  source: `(program
...
export const t346_async_not_error: TestCase = {
  ...
  expect: 'TypeError: ! expects 1 Bool',
  source: `(program
...
export const t347_async_sys_spawn_error: TestCase = {
  ...
  expect: 'TypeError: sys.spawn expects Str function name',
  source: `(program
...
export const t348_async_sys_send_error: TestCase = {
  ...
  expect: 'TypeError: sys.send expects I64 pid',
  source: `(program
...
export const t349_async_net_listen_error: TestCase = {
  ...
  expect: 'RuntimeError: net.listen expects I64 port',
  source: `(program
...
export const t352_async_net_write_error: TestCase = {
  ...
  expect: 'RuntimeError: net.write expects I64',
  source: `(program
...
export const t354_async_net_connect_error: TestCase = {
  ...
  expect: 'RuntimeError: net.connect expects Str host',
  source: `(program
...
export const t356_async_http_parse_response_error: TestCase = {
  ...
  expect: '(Err "Invalid status line")',
  source: `(program
