...
export const t147_wasm_snippet_list_get = {
  ...
  fn: async () => {
    ...
    const expected = [
      ...
      '(local.set $t1)',
      '(if (result i64)',
      '(i64.lt_u (local.get $t1) (i64.load (i32.wrap_i64 (local.get $t0))))',
      '(then',
      '(call $alloc (i64.const 16))',
      '(local.set $t2)',
      '(i64.store (i32.wrap_i64 (local.get $t2)) (i64.const 1))',
      '(i64.store (i32.wrap_i64 (i64.add (local.get $t2) (i64.const 8))) (i64.load (i32.wrap_i64 (i64.add (i64.add (local.get $t0) (i64.const 8)) (i64.mul (local.get $t1) (i64.const 8))))))',
      '(local.get $t2)',
      ')',
      '(else',
      '(call $alloc (i64.const 16))',
